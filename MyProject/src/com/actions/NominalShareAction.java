...
import com.services.NominalShareService;
import com.services.NominalShareServiceImpl;

import flexjson.JSONSerializer;

public class NominalShareAction extends ActionSupport implements ModelDriven<NominalInfoDto>, ServletRequestAware{
	...
	//private NominalShareService nominalService = null;
	private NominalInfoDto nomDto = new NominalInfoDto();
	
	private Date accountopendate;
	private Map<String, String> map = new HashMap<String, String>();
	private NominalShareService shareService = null;
	@Override
	public String execute() {
		...
		try{
		shareService = new NominalShareServiceImpl();
		NominalShareEntity rshareInfo = shareService.addUser(bankname,bankcode,memberid,accountno,userName,password,name,gender,age,phone,res,cell,qualification,
	...
	public String getNominalList(){
		...
		try{
			...
			shareService =new NominalShareServiceImpl();
				...
				List<NominalShareEntity> info = shareService.getNominalInfo(nomDto);
				session.setAttribute("nominallist", info);
				map.put("info", jss.serialize(info));
				map.put("fromDate", nomDto.getFromDate());
				map.put("toDate", nomDto.getToDate());
...
public String nominalmemberList() {
	session = request.getSession();
	JSONSerializer jss = new JSONSerializer();
	try {
...
public String updateNominal(){
	...
	try {
			...
			shareService = new NominalShareServiceImpl();
			shareService.updateNominal(slno,bankname,bankcode,memberid,accountno,userName,password,name,gender,age,phone,res,cell,qualification,
					caste,occupation,address,paddress,fsalary,fbusiness,frent,fsource,afhname,idoccupation,idaddress,omembership,ipapplicant,membersociety,
...
public String DeleteNominalShare() {
	session = request.getSession();
	try{
		
			shareService = new NominalShareServiceImpl();
			shareService.deletenominalshare(slno, NominalShareEntity.class);
	...
	@Override
	public NominalInfoDto getModel() {
