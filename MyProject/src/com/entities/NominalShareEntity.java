...
@Entity
@Table(name = "nominalshare")
@NamedNativeQuery(name="getNominalInfo", query = "select * from nominalshare where accountopendate between :fromDate and :toDate", resultClass=NominalShareEntity.class )
public class NominalShareEntity implements Serializable{
