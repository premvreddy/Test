...
@Entity
@Table(name = "ashare")
@NamedNativeQuery(name="getAshareInfo", query = "select * from ashare where accountopendate between :fromDate and :toDate", resultClass=AshareEntity.class )
public class AshareEntity implements Serializable{
