			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<fieldset  class="scheduler-border">
						<legend  class="scheduler-border">Member Account</legend>
								 ...
								 <label>Account Number</label><br/> 
									 <select placeholder="AccountNumber" id="combobox" >
										<option value="" selected="selected">Account Number</option>
											<s:iterator id="membean" value="#session.memberdetiallist1" status="i">
												<option value="${membean.accountno}">${membean.accountno}</option>
											</s:iterator>
										</select>
							</div>
						</div>
	...
	<div class="table-responsive" id="tableDiv" >
		<div class="wraper">
			...
			<table border="1"  id="jsonTable"
				...
				<tbody>
					<s:iterator id="membean1" value="#session.memdetaillist" status="i">
						<tr>
							 
								
								<td class="abc">${membean1.accountno}<input type="hidden"
								value="${membean1.accountno}" /></td>
														
								<td class="abc">${membean1.accountname}<input type="hidden"
								value="${membean1.accountname}" /></td>														
															
								<td>${membean1.date}<input type="hidden"
								value="${membean1.date}" /></td>
								
								<td>${membean1.entryNo}<input type="hidden"
								value="${membean1.entryNo}" /></td>
								
								<td>${membean1.particulars}<input type="hidden"
								value="${membean1.particulars}" /></td>
								
								<td>${membean1.debit}<input type="hidden"
								value="${membean1.debit}" /></td>
								
								<td>${membean1.credit}<input type="hidden"
								value="${membean1.credit}" /></td>
								
								<td>${membean1.balance}<input type="hidden"
								value="${membean1.balance}" /></td>
								
									<td>${membean1.type}<input type="hidden"
								value="${membean1.type}" /></td>
								
									<td class="abc">${membean1.memberId}<input type="hidden"
								value="${membean1.memberId}" /></td>
