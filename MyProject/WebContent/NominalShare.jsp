...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title" id="myModalLabel">Nominal Share	Application</h4>
				</div>
						...
						<div class="row" >
							<fieldset class="scheduler-border">
									<legend class="scheduler-border">Opening Balance_Details</legend>
										...
										<div class="col-sm-3">
											<div class="form-group">
												<label>Sub Group Name</label> <input type="text" id="subgroup" placeholder="Nominal Share Holder" value="Regular Share Holder" readonly="readonly"
												class="form-control" />
											</div>
										</div>
										<div class="col-sm-3">
	...
	<fieldset>
		<legend>
			Nominal Share Account Application
		</legend>
	</fieldset>
			<div class="row">
			<div class="col-xs-3">
	...
	<div class="table-responsive" id="tableDiv" >
		<div class="wraper">
			...
			<table border="1"  id="jsonTable"
				...
				<tbody>
					<s:iterator id="nominalbean" value="#session.nominallist" status="i">
						<tr>
							  <%-- <td>${nominalbean.slno}<input type="hidden"
								value="${nominalbean.slno}" /></td> --%>
								
							<td >${nominalbean.slno}<input type="hidden"
								value="${nominalbean.slno}" /></td> 
						
							 	<td class="abc">${nominalbean.bankname}<input type="hidden"
								value="${nominalbean.bankname}" /></td>
								
								<td class="abc">${nominalbean.bankcode}<input type="hidden"
								value="${nominalbean.bankcode}" /></td>
								
								<td>${nominalbean.memberid}<input type="hidden"
								value="${nominalbean.memberid}" /></td>
								
								<td class="ns-links1"><a
								href="#">${nominalbean.accountno}</a><input type="hidden"
								value="${nominalbean.accountno}" /></td>
								
								<td class="abc">${nominalbean.userName}<input type="hidden" 
								value="${nominalbean.userName}" /></td>
								
								<td class="abc">${nominalbean.password}<input type="hidden"
								value="${nominalbean.password}" /></td>
								
								<td >${nominalbean.name}<input type="hidden"
								value="${nominalbean.name}" /></td>
								
								<td class="abc">${nominalbean.gender}<input type="hidden"
								value="${nominalbean.gender}" /></td>
								
								<td>${nominalbean.age}<input type="hidden"
								value="${nominalbean.age}" /></td>
								
								<td>${nominalbean.phone}<input type="hidden"
								value="${nominalbean.phone}" /></td>
								
								<td class="abc">${nominalbean.res}<input type="hidden"
								value="${nominalbean.res}" /></td>
								
								<td >${nominalbean.cell}<input type="hidden"
								value="${nominalbean.cell}" /></td>
								
								<td class="abc">${nominalbean.qualification}<input type="hidden"
								value="${nominalbean.qualification}" /></td>
								
								<td  class="abc">${nominalbean.caste}<input type="hidden"
								value="${nominalbean.caste}" /></td>
								
								<td class="abc">${nominalbean.occupation}<input type="hidden"
								value="${nominalbean.occupation}" /></td>
								
								<td class="abc">${nominalbean.address}<input type="hidden"
								value="${nominalbean.address}" /></td>
								
								<td class="abc">${nominalbean.paddress}<input type="hidden"
								value="${nominalbean.paddress}" /></td>
								
								<td class="abc">${nominalbean.fsalary}<input type="hidden"
								value="${nominalbean.fsalary}" /></td>
								
								<td class="abc">${nominalbean.fbusiness}<input type="hidden"
								value="${nominalbean.fbusiness}" /></td>
								
								<td class="abc">${nominalbean.frent}<input type="hidden"
								value="${nominalbean.frent}" /></td>
								
								<td class="abc">${nominalbean.fsource}<input type="hidden"
								value="${nominalbean.fsource}" /></td> 
								
								<td class="abc">${nominalbean.afhname}<input type="hidden"
								value="${nominalbean.afhname}" /></td> 
								
								<td class="abc">${nominalbean.idoccupation}<input type="hidden"
								value="${nominalbean.idoccupation}" /></td> 
								
								<td class="abc">${nominalbean.idaddress}<input type="hidden"
								value="${nominalbean.idaddress}" /></td>
								 
								<td class="abc">${nominalbean.omembership}<input type="hidden"
								value="${nominalbean.omembership}" /></td>
								 
								<td class="abc">${nominalbean.ipapplicant}<input type="hidden"
								value="${nominalbean.ipapplicant}" /></td>
								 
								<td class="abc">${nominalbean.membersociety}<input type="hidden"
								value="${nominalbean.membersociety}" /></td>
								 
								<td class="abc">${nominalbean.nmname}<input type="hidden"
								value="${nominalbean.nmname}" /></td>
								
								<td class="abc">${nominalbean.relation}<input type="hidden"
								value="${nominalbean.relation}" /></td>
								
								<td class="abc">${nominalbean.nmaddress}<input type="hidden"
								value="${nominalbean.nmaddress}" /></td>
								
								<td class="abc">${nominalbean.name1}<input type="hidden"
								value="${nominalbean.name1}" /></td>
								
								<td class="abc">${nominalbean.accountno1}<input type="hidden"
								value="${nominalbean.accountno1}" /></td>
								
								<td class="abc">${nominalbean.name2}<input type="hidden"
								value="${nominalbean.name2}" /></td>
								
								<td class="abc">${nominalbean.accountno2}<input type="hidden"
								value="${nominalbean.accountno2}" /></td>
								
								<td class="abc">${nominalbean.shareamount}<input type="hidden"
								value="${nominalbean.shareamount}" /></td>
								
								<td class="abc">${nominalbean.openingbalance}<input type="hidden"
								value="${nominalbean.openingbalance}" /></td>
								
								<td class="abc">${nominalbean.obtype}<input type="hidden"
								value="${nominalbean.obtype}" /></td>
								
								<td class="abc">${nominalbean.subgroup}<input type="hidden"
								value="${nominalbean.subgroup}" /></td>
								
								<td class="abc">${nominalbean.maingroup}<input type="hidden"
								value="${nominalbean.maingroup}" /></td>
	...
	<!-- <input type="button" class="ns-links" id="new1" value="NEW" /> -->
			...
			<div class="modal-content">
				<div class="modal-header">
					...
					<div class="row">
						...
						<div class="col-sm-3">
							<div class="form-group">
								<label>Account No</label> <input type="text" id="accountno" readonly="readonly"
									autocomplete="off" class="form-control" />
							</div>
						</div>
				...
				$(document).ready(function(){
					...
					$("#addNewUser").click(function() {
						...
						if ($.trim(bankname).length == 0) {
							...
							alert("Provide Name of Applicant");
						} else if($.trim(gender).length == 0) {
							alert("Provide Gender");
						}  else if($.trim(age).length == 0) {
							alert("Provide Age");
						...
						} else if($.trim(res).length == 0) {
							alert("Provide Residence Number");
						} else if($.trim(cell).length == 0) {
							alert("provide Cell Number");
						}  else if($.trim(qualification).length == 0) {
							alert("Provide Qualification");
						}else if($.trim(caste).length == 0) {
							alert("Provide Caste");
						} else if($.trim(occupation).length == 0) {
							alert("Provide Occupation");
						}else if($.trim(address).length == 0) {
							alert("Provide Address");
						}else if($.trim(paddress).length == 0) {
							alert("Provide Permanent address");
						}else if($.trim(fsalary).length == 0) {
							alert("Provide Salary");
						}else if($.trim(fbusiness).length == 0) {
							alert("Provide Business Income");
						}else if($.trim(frent).length == 0) {
							alert("Provide Rent Income");
						}else if($.trim(fsource).length == 0) {
							alert("Provide Source of Income");
						}else if($.trim(afhname).length == 0) {
							alert("Provide Applicant Father/Husband");
						}else if($.trim(idoccupation).length == 0) {
							alert("Provide Income Occupation");
						}else if($.trim(idaddress).length == 0) {
							alert("Provide Applicant address");
						}else if($.trim(omembership).length == 0) {
							alert("Provide Object Memebership");
						}else if($.trim(ipapplicant).length == 0) {
							alert("Provide Immovable property");
						}else if($.trim(membersociety).length == 0) {
							alert("Provide Member Society");
						}else if($.trim(nmname).length == 0) {
							alert("Provide Nominee Name");
						}else if($.trim(relation).length == 0) {
							alert("Provide Nominee Relation");
						}else if($.trim(nmaddress).length == 0) {
							alert("Provide Nominee address");
						}else if($.trim(name1).length == 0) {
							alert("Provide Ref Name");
						}else if($.trim(accountno1).length == 0) {
							alert("Provide Ref Account Number");
						}else if($.trim(name2).length == 0) {
							alert("Provide Ref Name");
						}else if($.trim(accountno2).length == 0) {
							alert("Provide Account Number");
						}else {
								var parms = {
										bankname : bankname,
