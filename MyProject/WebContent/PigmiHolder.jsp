		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title" id="myModalLabel">PigmiHolder</h3>
				</div>
<div class="modal-body">
	<fieldset class="scheduler-border">

		<legend class="scheduler-border">PigmiHolder_info</legend>
		...
		<div class="row">
				...
				<div class="form-group">
					<div class="form-group required">
						<label class="control-label">PigmiHolder Name</label> <input
							type="text" id="pigmiholdername" class="form-control">
					</div>
				</div>	
			</div>
				...
				<div class="form-group">
					<div class="form-group required">
						<label class="control-label">PigmiHolder Code</label><input
							type="text" id="pigmiholdercode" class="form-control">
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="form-group required">
					<label class="control-label">PigmiHolder Account No</label> <input
						type="text" id="pigmiholderaccount" class="form-control">
				</div>
			</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div class="form-group required">
					<label class="control-label">City</label> <select id="city"
						class="form-control">
			...
			<div class="col-sm-3">
				<div class="form-group">
					<div class="form-group required">
						<label class="control-label">Pin</label><input type="number"
		...
		<div class="row">
			<div class="col-sm-3">
				<div class="form-group">
					<label>Contact Number</label><input type="number" id="contactnumber"
						class="form-control">
				</div>
			</div>
...
$(document).ready(function(){
	...
	alert("hi");
	var pigmiholdername = $('#pigmiholdername').val();
	var pigmiholdercode = $('#pigmiholdercode').val();
	var pigmiholderaccount = $('#pigmiholderaccount').val();
	...
	var address = $('#address').val();
			var parms = {
					pigmiholdername : pigmiholdername,
					pigmiholdercode : pigmiholdercode,
					pigmiholderaccount : pigmiholderaccount,
					agentname : agentname,
					agentcode : agentcode,
					city : city,
					area : area,
