...
<s:set name="receiptnumber" value="#session.receiptnumberinc" />
<!DOCTYPE html>
...
<body>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h3 class="modal-title" id="myModalLabel">Deposit</h3>
				</div>
					...
					<div class="row">
						...
						<div class="row">
							<div class="form-group">
								...
								<div class="col-sm-2">
									<div class="form-group">
										<label>Receipt No</label> <input type="text" id="receiptno"
											autocomplete="off" class="form-control" />
									</div>
								...
								<div class="col-xs-2">
									<div class="form-group">
										<div class='input-group date' data-provide="datepicker"
											...
											<label> Date </label><input id="receiptdate"
	...
	<!-- <input type="button" class="rs-links" id="addreceipt"
		value="AddNewReceipt" /> -->
	<div class="row">
		<div class="col-xs-3">
	...
	<div class="table-responsive" id="tableDiv">
		<div class="wraper">
			...
			<table border="1" id="jsonTable"
				...
				<tbody>
					<s:iterator id="receiptbean" value="#session.receiptlist"
						status="i">
						<tr>
							...
							<td class="abc">${receiptbean.branchname}<input
								type="hidden" value="${receiptbean.branchname}" /></td>

							<td class="abc">${receiptbean.branchcode}<input
								type="hidden" value="${receiptbean.branchcode}" /></td>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#submit").click(function() {
				...
				else if($.trim(receiptno).length == 0) {
			    	alert("Provide receiptno");
			    }
		...
		function cal_total_Amount() {
			var one_amount = document.getElementById("one_amount").value;
