...
<body>
	...
	<div class="table-responsive" id="tableDiv" >
	 ...
	 <div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
												<input type="text" id="crd" class="form-control1 no-border"
													class="form-control" value="Rs.00" />
										</div>
								</div>
							</div>	
							...
							<div class="row">		
								...
								<div class="col-sm-6">
									<div class="form-group">
												<input type="text" id="grt" class="form-control1 no-border"
													class="form-control" value="Rs.00" />
										</div>
								</div>
							</div>
	<%-- 
							<div>
								<button type="button"  id="newjournal"  data-type='New'
...
$("#newjournal").click(function() {
			...
			$.ajax({
					...
					var address = "openingbalance.jsp?Time="+ (new Date()).getTime();
							$.ajax({
								url : address,
								success : function(data) {
										$('#workarea').html(data);
